...
ply1 = PlyImporter("initial_a.ply")
ply2 = PlyImporter("velocity.ply")
dim = 3
n1 = ply1.get_count()
n2 = ply2.get_count()
n_particles = n1
...
def initial_state():
    x.from_numpy(np.concatenate((ply1.get_array(), ply2.get_array())))
    J.fill(1)


def update_v():
    grid_v.from_numpy(ply2.get_array().reshape(n_grid, n_grid, n_grid, 3))


initial_state()
ply2.multiply(dt * 0.00005)
